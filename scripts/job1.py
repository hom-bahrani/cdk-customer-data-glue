...
customer_df = glueContext.create_dynamic_frame.from_catalog(database = db_name, table_name = tbl_name)
...
# write output to S3
glueContext.write_dynamic_frame.from_options(frame = customer_df, connection_type = "s3", connection_options = {"path": output_dir}, format = "json")
